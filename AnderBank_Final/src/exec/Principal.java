...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
		...
		Conta c1 = new Conta();
                ...
                Funcionario funcionarioT1 = new Funcionario("Algusto Moura da Silva", "Caixa", 4000, "75413945245","4012952941");
                Funcionario funcionarosT2 = new Funcionario("Renata Moura Araújo", "Caixa", 4000, "64357128435","02840147524");
                lc3.add(funcionarioT1);
                lc3.add(funcionarosT2);
                AnderBank.setFuncionarios(lc3);
                
                Diretor diretorT = new Diretor("Anderson Lemos da Silva","Diretoria", 10000, "186437835484" ,"Diretor", "02847105284");
                lc4.add(diretorT);
                AnderBank.setDiretores(lc4);
                
                Gerente gerenteT = new Gerente("Alysson Alexandre de Oliveira Araújo","Gerencia Administratva ", 10000,"28492531745","9420414052");
                Gerente gerenteT2 = new Gerente("Dheymison Nunes Alexandre","Gerencia Administratva ", 10000,"75431984683","4018304751");
                lc5.add(gerenteT);
                lc5.add(gerenteT2);
                AnderBank.setGerentes(lc5);
                
                
                ContaCorrente contaCorrenteT1 = new ContaCorrente(7249375, "Henricky De Lima Monteiro", 560, "ContaCorrente", "8018631472");
                contaCorrenteT1.gerarTaxa();
                ContaCorrente contaCorrenteT2 = new ContaCorrente(7894561, "Jefferson do Nascimento Sousa", 80000, "ContaCorrente", "4862798510");
                contaCorrenteT2.gerarTaxa();
                ContaCorrente contaCorrenteT3 = new ContaCorrente(1818431, "Anderson Lemos da Silva", 10000, "ContaCorrente", "1874985621");
                ...
                ContaPoupanca contaPoupancaT1 = new ContaPoupanca(4249375, "Henricky De Lima Monteiro", 95000, "ContaPoupanca", "184730524");
                contaPoupancaT1.gerarTaxa();
                ContaPoupanca contaPoupancaT2 = new ContaPoupanca(9291361, "Jefferson do Nascimento Sousa", 80000, "ContaPoupanca", "4628104351");
                contaPoupancaT2.gerarTaxa();
                ContaPoupanca contaPoupancaT3 = new ContaPoupanca(7518131, "Anderson Lemos da Silva", 20000000, "ContaPoupanca", "7439581350");
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
		...
		do{
			...
			System.out.println("5) Adicionar funcionario;");
                        ...
                        System.out.println("13) Fazer transferencia de uma conta para outra.");
			...
			switch(opcao) {
				case 1:
                                    ...
                                    if(num==1){
                                        ...
                                        System.out.println("Digite o CDF:");
                                        String cpf = in.nextLine();
                                        
                                        ContaCorrente contaCorrente = new ContaCorrente(numeroConta, titular, saldoInicial, tipoConta, cpf);
                                    ...
                                    if(num==2){
                                        ...
                                        ContaPoupanca contaPoupanca = new ContaPoupanca(numeroConta,titular, saldoInicial, tipoConta,cpf);
				...
				case 4:
                                ...
                                case 5:
                                    ...
                                    System.out.println("Nome do Funcionário:");
                                        ...
                                        Funcionario funcionarioNovo = new Funcionario(funcionario, departamento, salarioInicial, RG,cpf);
                                ...
                                case 6:
                                    ...
                                    System.out.println("Nome do Diretor:");
                                        ...
                                        Diretor diretorNovo = new Diretor(diretor, departamento, salarioInicial, RG, tipoFuncionario, cpf);
                                        lc4.add(diretorNovo);
                                        AnderBank.setDiretores(lc4);
                                        }
                                    catch(NumberFormatException e){System.out.println("Valores Errados. Por favor, escreva aquilo que está sendo pedido no formato correto!" + " \n Voltando para o menu...");}
                                ...
                                case 7:
                                    ...
                                    System.out.println("Nome do Gerente:");
                                        ...
                                        Diretor diretorNovo = new Diretor(diretor, departamento, salarioInicial, RG, "Diretor", cpf);
                                        lc4.add(diretorNovo);
                                        AnderBank.setDiretores(lc4);
                                        }
                                    catch(NumberFormatException e){System.out.println("Valores Errados. Por favor, escreva aquilo que está sendo pedido no formato correto!" + " \n Voltando para o menu...");}
                                ...
                                case 13:
                                    try{
                                        System.out.println("Digite o número da conta que deseja retirar o dinheiro para depositar em outra: ");
                                        int numeroContaRetirar = Integer.parseInt(in.nextLine());
                                        System.out.println("Digite o número da conta que vai receber o dinheiro da conta pedida anteriormente:");
                                        int numeroContaReceber = Integer.parseInt(in.nextLine());
                                        boolean verifc = false;
                                        
                                        //de corrente para corrente
                                        for(ContaCorrente aux1 : AnderBank.getContaCorrente()){
                                            if(aux1.getNumero()== numeroContaRetirar){
                                                for(ContaCorrente aux2: AnderBank.getContaCorrente()){
                                                    if(aux2.getNumero()== numeroContaReceber){
                                                        verifc = true;
                                                        System.out.println("Digite o valor que deseja transferir para a conta "+ numeroContaReceber);
                                                        double dinheiro = Double.parseDouble(in.nextLine());
                                                        aux1.transfere(aux2, dinheiro);
                                                    }
                                                }
                                            }
                                        }
                                        //de corrente para poupanca
                                        for(ContaCorrente aux1 : AnderBank.getContaCorrente()){
                                            if(aux1.getNumero()== numeroContaRetirar){
                                                for(ContaPoupanca aux2: AnderBank.getContaPoupanca()){
                                                    if(aux2.getNumero()== numeroContaReceber){
                                                        verifc = true;
                                                        System.out.println("Digite o valor que deseja transferir para a conta "+ numeroContaReceber);
                                                        double dinheiro = Double.parseDouble(in.nextLine());
                                        ...
                                        //de poupanca para corrente
                                        for(ContaPoupanca aux1 : AnderBank.getContaPoupanca()){
                                            if(aux1.getNumero()== numeroContaRetirar){
                                                for(ContaCorrente aux2: AnderBank.getContaCorrente()){
                                                    if(aux2.getNumero()== numeroContaReceber){
                                                        verifc = true;
                                        ...
                                        if(verifc == false){
                                            System.out.println("Uma das contas pedidas não foi encontrada. Motivo: Não está registrado uma das duas.");
                                        }
                                    }
                                    catch(NumberFormatException e){System.out.println("Valor não aceito. Digite um valor numérico correto.");}    
                                    break;
