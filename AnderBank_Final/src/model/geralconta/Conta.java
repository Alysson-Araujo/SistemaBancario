...
public class Conta {
    ...
    protected String cpf;
        ...
        public Conta(int numero, String titular, double saldo, String tipoConta, String cpf){ 
		this.numero = numero;
    ...
    public boolean sacar(double valor){
        try{
        if(valor<0){
            throw new IllegalArgumentException("Você tentou Sacar um valor negativo. Por favor, digite valores que sejam positivos");
            }
        }
    ...
    public void transfere(Conta destino, double valor) {
        ...
        saldonovo = destino.saldo + valor;
        
        destino.saldo = saldonovo;
